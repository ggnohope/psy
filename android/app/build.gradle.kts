...
// Release signing secrets — kept in keystore.properties (gitignored), never in VCS.
...
android {
    ...
    buildTypes {
        release {
            ...
            // Production backend (HTTPS). Overrides the dev default from defaultConfig.
            resValue("string", "base_url", "https://psy-backend.duckdns.org/")
        }
    }
    compileOptions {
